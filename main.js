...
instructions.innerHTML = "<b>enter adds note, a logs notes, ijkl zoom, s resets zoom, 1234567890 play samples, d plays drum pattern, g plays melody, h plays sample pattern, q plays effects, w changes q's parameter, e plays effected sample, r plays ambience, t plays sampleSong2, y plays chordSong, u plays chordy sample song, o tests command, p plays chordy partitioned sample song, å plays chordy partitioned sample song 2, z plays chordy partitioned sample song 3, x plays more chordy song, c plays reharmonic song, v plays multiharmonic song</b>"
document.addEventListener('keydown', (event) => {
  switch (event.key) {
    ...
    case 'x':
      ...
      break
    case 'c':
      songs.playReharmonicSong()
      break
    case 'v':
      songs.playMultiharmonicSong()
      break
  }
})
