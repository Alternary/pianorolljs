...
async function playReharmonicSong() {
  ...
  melodies = utils.groupBy(musicUtils.generateOverAndUnderToneSequence(seed, 9, 4, 2, musicUtils.randomFloatContinuum(0.1, 99 * melodyAmount, 32, seed)).map(freq => musicUtils.freqToInt(freq)), melodyAmount); melodies = utils.zipLists(melodies) //need to transpose as they get retransposed down below
